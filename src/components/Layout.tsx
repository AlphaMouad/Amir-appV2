...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex font-inter text-slate-100 pb-20 md:pb-0 relative overflow-hidden">
      ...
      <aside className="w-72 glass-sidebar hidden md:flex flex-col shrink-0 sticky top-0 h-screen z-20">
        <div className="p-8 mb-2">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center shadow-[0_0_24px_rgba(79,70,229,0.4)] border border-white/10">
              <span className="font-outfit font-black text-2xl text-white">V</span>
            </div>
            <div>
              <h1 className="text-xl font-outfit font-black tracking-tight text-white">ELITE<span className="text-indigo-400 font-medium">FINANCE</span></h1>
              <p className="text-[10px] text-indigo-200/60 uppercase tracking-[0.2em] mt-0.5 font-bold">Management</p>
            </div>
          </div>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <item.icon className={`h-5 w-5 relative z-10 transition-colors ${isActive ? 'text-indigo-400 drop-shadow-[0_0_8px_rgba(79,70,229,0.5)]' : 'text-slate-500 group-hover:text-slate-300'}`} />
      ...
      <header className="glass-nav h-16 flex items-center justify-between px-6 md:hidden fixed top-0 left-0 right-0 z-20">
        <div className="flex items-center gap-3">
           <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center shadow-[0_0_12px_rgba(79,70,229,0.4)]">
              <span className="font-outfit font-black text-sm text-white">V</span>
            </div>
            <h1 className="text-lg font-outfit font-black tracking-tight text-white">ELITE<span className="text-indigo-400 font-medium">FINANCE</span></h1>
        </div>
